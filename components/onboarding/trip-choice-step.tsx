...
export function TripChoiceStep({ onNext, onCreateTrip, onJoinTrip, updateData }: TripChoiceStepProps) {
  ...
  const choices = [
    ...
    },
    {
      ...
      features: [
        "Quick 3-digit code entry",
        "Instant access to group",
        "See existing expenses"
      ],
      ...
      >
        ...
        <div className="space-y-4">
          {choices.map((choice, index) => (
            ...
            >
              <Card
                className="bg-gray-800 border-gray-700 cursor-pointer hover:bg-gray-750 transition-all duration-200 hover:scale-105 group"
